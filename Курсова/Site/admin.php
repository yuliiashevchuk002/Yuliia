...
<div class="sub-menu-1">
	...
	<li><a href="signup.php"><i class="fa fa-key"></i>Sing up</a></li>
...
<div class="contsine">
	...
	<h2>Audit for you</h2>
	<p class="text-center"><i class ="fa fa-user-secret"></i>Admin</p>
...
<div class="row">
	<div class="col-md">
		<form action=""class="shadow-lg p-4" method="POST">
			...
			<i class="fa fa-user"></i><label  for="email" class="front-weight"></label><input type="email" class="form-control" placeholder="Email" name="aEmail">
			</div>
<div class="form-group">
	<i class="fa fa-key"></i><label  for="pass" class="front-weight"></label><input type="password" class="form-control" placeholder="Password" name="aPassword">
</div>
...
$sql= "SELECT email, password FROM login_admin WHERE email = '".$aEmail."' AND password = 
'".$aPassword."' limit 1";
...
echo "<script> location.href='admin_profile.php';</script>";
 	...
 	$regmsg = '<div class="alter-1" `>Enter valid email and password</div>';
 }
